...
public interface GraphADT<T> { 
    ...
    /**
     * Returns the list of shortest path between startingVertex and destinationVertex.
     ...
     */
    public int getShortestPathCost(T start, T end);
    
    /**
     * Return the list of path between startingVertex and destinationVertex using Prim's algorithm.
     * 
     * @param start the data item in the starting vertex for the path
     * @param end the data item in the destination vertex for the path
     * @return list of data item in vertices in order on the path between vertex with data item startingVertex and vertex with data item destinationVertex, including both startingVertex and destinationVertex
     */
    public List<T> primPath(T start, T end);
    
    /**
     * Returns the cost of the path using Prim's algorithm between startingVertex and destinationVertex.
     * 
     * @param start the data item in the starting vertex for the path
     * @param end the data item in the destination vertex for the path
     * @return the cost of the Prim's path between vertex with data item startingVertex and vertex with data item destinationVertex, including both startingVertex and destinationVertex
     */
    public int getPrimPathCost(T start, T end);
    
    /**
     * Checks user's input then compare with answers from the shortestPath method
     * @param input receive user's input as a list of path
     * @param start used for running the shortestPath method
     * @param end used for running the shortestPath method
     * @return true if the input is equivalent with one of the path by the shortestPath
     */
    public boolean checkAnswer(List<T> input, T start, T end);
